...
// import { getInstructors, verifyInstructor, deleteInstructor, getInstructorCourses } from '../api';
...
//   <button onClick={() => setActiveTab('sold')} className={activeTab === 'sold' ? 'active' : ''}>Sold Courses</button>
//   <button onClick={() => setActiveTab('done')} className={activeTab === 'done' ? 'active' : ''}>Payments Done</button>
...
//               <p><strong>Account Number:</strong> {selectedInstructor.accountNumber}</p>
