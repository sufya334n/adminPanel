...
// import { getUsers, blockUser, deleteUser } from '../api';
  ...
  <div className="user-courses">
    ...
    {process.env.NODE_ENV === 'development' && (
      <div className="debug-info">
        ...
        <p>First Course: {enrolledCourses.length > 0 ? JSON.stringify(enrolledCourses[0]) : 'None'}</p>
      </div>
    )} */}
  </div>
)}
...
{activeTab === 'purchased' && (
  <div className="user-courses">
    ...
    {loadingCourses.purchased ? (
      ...
      <div className="courses-grid">
        {purchasedCourses.map(course => {
          console.log("Purchased Course Data: ", course);  // Log course data for purchased courses
          return (
            <div className="course-item" key={course._id}>
              <img 
                src={course.image || 'https://via.placeholder.com/150'} 
